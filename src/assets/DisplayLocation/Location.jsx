  ...
  return (
    <div className={style.main}>
      <div className={style.heroHeader}>
        ...
        <p className={style.myTravel}>my travel journal.</p>
      </div>
      <div className='toursLocation'>
        {data.map((el) => {
          return (
            <div className={style.tourContainer}>
              <img className={style.image} src={el.imageUrl} alt='' />
              <div className={style.tourDescribtion}>
                <div>
                  <svg
                    width='7'
                    height='10'
                  ...
                  <a className={style.googleMapsUrl} href={el.googleMapsUrl}>
                    View on Google Maps
                  </a>
                </div>
